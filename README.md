...
1. Der Code liegt in einem Jupyter Notebook und wurde lediglich in Google Colab entwickelt. Funktionen, wie die interaktive Karte könnten ggf. nicht funktionieren. Wir Empfehlen daher das Notebook in Google Colab auszuführen.
